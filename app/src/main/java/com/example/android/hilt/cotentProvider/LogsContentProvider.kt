package com.example.android.hilt.cotentProvider
...
//            getLogDao do not compile because Hilt doesn't support injecting ContentProvider out of the box with activity
//            we need to create new interface annotated with @EntryPoint to access it.
